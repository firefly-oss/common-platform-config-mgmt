...
/**
 * Mapper for TenantStatus entity and DTO
 */
...
public interface TenantStatusMapper {
     ...
     * @param entity TenantStatus entity
     * @return TenantStatusDTO
     */
    TenantStatusDTO toDTO(TenantStatus entity);

    /**
     * Convert DTO to entity
     * @param dto TenantStatusDTO
     * @return TenantStatus entity
     */
    @Mapping(target = "createdAt", ignore = true)
    @Mapping(target = "updatedAt", ignore = true)
    TenantStatus toEntity(TenantStatusDTO dto);
}
