...
/**
 * Entity representing a provider in the Firefly core banking system.
 * Providers are external services that Firefly integrates with (payment gateways, KYC, etc.)
 */
@Data
@Builder
@NoArgsConstructor
